...
class BehaviorProjectLimsApi(BehaviorProjectBase):
    ...
    def _get_behavior_summary_table(self,
        ...
        query = f"""
            ...
            LEFT OUTER JOIN donors d on bs.donor_id = d.id
            LEFT OUTER JOIN genders g on g.id = d.gender_id
            LEFT OUTER JOIN (
    ...
    def _get_experiment_table(
        ...
        query = f"""
            ...
            LEFT OUTER JOIN donors d ON d.id = bs.donor_id
            LEFT OUTER JOIN genders g ON g.id = d.gender_id
            LEFT OUTER JOIN (
            ...
            LEFT OUTER JOIN imaging_depths id ON id.id = oe.imaging_depth_id
            LEFT OUTER JOIN structures st ON st.id = oe.targeted_structure_id
